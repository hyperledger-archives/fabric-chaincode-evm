...
-----END CERTIFICATE-----`
			...
			*/
			...
			// signed ethereum raw transaction
			signedTransaction = []byte("f86d820144843b9aca0082520894b78777860637d56543da23312c7865024833f7d188016345785d8a0000802ba0e2539a5d9f056d7095bd19d6b77b850910eeafb71534ebd45159915fab202e91a007484420f3968697974413fc55d1142dc76285d30b1b9231ccb71ed1e720faae")
		)
		...
		It("can execute any properly signed transaction", func() {
			stub.GetArgsReturns([][]byte{[]byte("rawTransaction"), signedTransaction})
			res := evmcc.Invoke(stub)
			Expect(res.Status).To(Equal(int32(shim.OK)))
		})
